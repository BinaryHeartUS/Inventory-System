...
BEGIN
    ...
    INSERT INTO Device(ID, Manufacturer_ID, Model, Year, CPU, RAM, RAM_Generation_ID, Storage_Amount, Storage_Type_ID, Status, Recipient_ID, Donated_Date, OS_ID)
    VALUES (p_Asset_ID, v_Manufacturer_ID, p_Model, p_Year, p_CPU, p_RAM, v_RAM_Generation_ID, p_Storage_Amount, v_Storage_Type_ID, p_Status, p_Recipient_ID, p_Donated_Date, v_OS_ID);
END;
$$;