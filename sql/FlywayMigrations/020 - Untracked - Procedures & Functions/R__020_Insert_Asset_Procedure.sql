DROP PROCEDURE IF EXISTS Insert_Asset;
...
BEGIN
    IF p_ID IS NULL THEN
        ...
        VALUES (p_Acquisition_Date, p_Value, p_Chapter_ID, p_Donor_ID)
        RETURNING ID INTO p_ID;
    ELSE
        INSERT INTO Asset (ID, Acquisition_Date, Value, Chapter_ID, Donor_ID)
        VALUES (p_ID, p_Acquisition_Date, p_Value, p_Chapter_ID, p_Donor_ID);
    END IF;
END;
$$;