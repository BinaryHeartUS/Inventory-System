...
CREATE OR REPLACE PROCEDURE Insert_Tablet(
...
AS $$
BEGIN
    CALL Insert_Device(p_Chapter_ID, p_Manufacturer, p_Model, p_Year, p_Status, p_Asset_ID, p_CPU, p_RAM, p_RAM_Generation, p_Storage_Amount, p_Storage_Type, p_Value, p_Acquisition_Date, p_Recipient_ID, p_Donor_ID, p_Donated_Date, p_Operating_System, p_Serial_Number);
