DROP TRIGGER IF EXISTS Trg_Update_Desktop_Change_Log ON Desktop;
DROP FUNCTION IF EXISTS Update_Desktop_Change_Log();

CREATE FUNCTION Update_Desktop_Change_Log()
RETURNS TRIGGER
LANGUAGE plpgsql
AS $$
BEGIN
...
CREATE TRIGGER Trg_Update_Desktop_Change_Log
