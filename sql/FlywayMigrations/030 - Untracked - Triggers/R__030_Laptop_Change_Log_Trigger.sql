DROP TRIGGER IF EXISTS Trg_Update_Laptop_Change_Log ON Laptop;
DROP FUNCTION IF EXISTS Update_Laptop_Change_Log();

CREATE FUNCTION Update_Laptop_Change_Log()
RETURNS TRIGGER
LANGUAGE plpgsql
AS $$
BEGIN
...
CREATE TRIGGER Trg_Update_Laptop_Change_Log
