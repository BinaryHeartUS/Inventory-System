...
export const STATUS_CONFIG: Record<
  DeviceStatus,
  { dot: string; badge: string; badgeDark: string }
> = {
  "Not Started": {
    dot: "bg-slate-400",
    badge: "bg-slate-100  text-slate-500",
    badgeDark: "bg-white/10      text-slate-300",
  },
  "In Progress": {
    dot: "bg-amber-500",
  ...
  "Ready To Donate": {
    ...
    badgeDark: "bg-green-500/25   text-green-200",
  },
  Donated: {
    dot: "bg-sky-500",
    badge: "bg-sky-50     text-sky-700",
    badgeDark: "bg-sky-400/30     text-sky-100",
  },
  Scrapped: {
    dot: "bg-red-400",
    badge: "bg-red-50     text-red-600",
    badgeDark: "bg-red-500/25     text-red-200",
  },
  Unknown: {
    dot: "bg-gray-300",
    badge: "bg-gray-100   text-gray-400",
    badgeDark: "bg-white/8        text-slate-400",
  },
};
