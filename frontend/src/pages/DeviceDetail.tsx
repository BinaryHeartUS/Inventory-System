      ...
      <div className="bg-slate-800 rounded-xl px-8 py-6">
        <div className="flex items-stretch justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl font-bold text-white">{d.manufacturer} {d.model}</h1>
          ...
          <div className="flex items-stretch gap-3 shrink-0">
            ...
            {!editing && (
              <button onClick={() => setPrintId(d.id)}
                className="flex items-center gap-2 text-sm font-medium text-white bg-white/15 hover:bg-white/25 px-4 py-2.5 rounded-lg transition-colors">
            ...
            {!editing ? (
              <button onClick={startEdit}
                className="flex items-center gap-2 text-sm font-medium text-slate-700 bg-white hover:bg-slate-100 px-4 py-2.5 rounded-lg transition-colors">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <>
                <button onClick={cancelEdit}
                  className="text-sm font-medium text-white/80 hover:text-white px-4 py-2.5 rounded-lg border border-white/30 transition-colors">
                  Cancel
                </button>
                <button onClick={saveEdit}
                  className="text-sm font-medium text-slate-700 bg-white hover:bg-slate-100 px-4 py-2.5 rounded-lg transition-colors">
                  Save changes
                </button>
              </>
            )}
