...
export function DeleteConfirmButton({ noun, showing, onShowConfirm, onConfirm, onCancel, disabled, disabledTitle }: {
  noun: string
  showing: boolean
  onShowConfirm: () => void
  onConfirm: () => void
  ...
  return (
    <button onClick={onShowConfirm} disabled={disabled} title={disabledTitle}
