...
/**
 * PartyDetailView — presentational party detail: header, info card, donation
 * receipt selection flow, and the donated/received asset tables. Owns the local
 * selection + section-expand UI state.
 */
