...
/**
 * DeviceDetailView — presentational device detail: header, specifications (view
 * + edit forms), type-specific sections, linked parts, modification history,
 * notes pane, and the print/party/recipient/ready-to-donate modals.
 */
