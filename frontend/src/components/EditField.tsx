...
export function EditText({ label, value, onChange, type = 'text', placeholder, min, max, maxLength }: {
...
export function EditSelect<T extends string>({ label, value, options, onChange }: {
...
export function EditCombo({ label, value, options, onChange, placeholder, maxLength }: {
