...
/**
 * PartySectionView — presentational party table for one party kind, with search,
 * an add/edit inline panel (Person/Org panel containers), and per-row actions.
 * Owns the local search text and which row is expanded.
 */
export default function PartySectionView({
  isPerson,
  items,
  loading,
  listError,
