...
public class DatabaseImporter {
  private static final LocalDate IMPORT_ACQUISITION_DATE =
      LocalDate.parse("10-1-2025", DateTimeFormatter.ofPattern("M-d-yyyy"));
  ...
  public static void addDesktopsToDatabase(List<Desktop> desktops, int chapterID) {
    ...
    try (CallableStatement stmt =
        conn.prepareCall("call Insert_Desktop(?, ?, ?, ?, ?::Status, ?)")) {
  ...
  public static void addLaptopsToDatabase(List<Laptop> laptops, int chapterID) {
    ...
    Connection conn = DatabaseConnectionService.getConnection();
    try (CallableStatement stmt =
        conn.prepareCall("call Insert_Laptop(?, ?, ?, ?, ?::Status, ?::Charger_Status, ?)")) {
  ...
  public static void addTabletsToDatabase(List<Tablet> tablets, int chapterID) {
    ...
    try (CallableStatement stmt =
        conn.prepareCall(
            "call Insert_Tablet(?, ?, ?, ?, ?::Status, ?::Charger_Status, ?::Working_Battery, ?)")) {
