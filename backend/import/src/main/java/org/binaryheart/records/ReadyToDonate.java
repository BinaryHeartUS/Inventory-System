...
public record ReadyToDonate(String deviceName, String manufacturer, TypeOfDevice typeOfDevice, Integer estimatedYear,
        String cpu, OperatingSystem os, Integer ramAmount, String ramGeneration, Integer storageCapacity,
        String storageType, Integer estimatedValue, String notes, Integer ID) {
