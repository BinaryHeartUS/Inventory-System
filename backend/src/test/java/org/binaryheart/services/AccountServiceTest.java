...
class AccountServiceTest {
	...
	@Test
	void createAccountEnforcesRoleAndChapterPermissions() throws Exception {
		AccountRepository repository = mock(AccountRepository.class);
		AuthRepository authRepository = mock(AuthRepository.class);
		ChapterService chapters = mock(ChapterService.class);
		PasswordService passwords = mock(PasswordService.class);
	...
	@Test
	void getAccountsUsesRoleAppropriateRepositoryAndFiltersElevatedAccounts() throws Exception {
		AccountRepository repository = mock(AccountRepository.class);
		AuthRepository authRepository = mock(AuthRepository.class);
		ChapterService chapters = mock(ChapterService.class);
		PasswordService passwords = mock(PasswordService.class);
	...
	@Test
	void deleteAccountProtectsSelfAndEnforcesChapterAdminScope() throws Exception {
		AccountRepository repository = mock(AccountRepository.class);
		AuthRepository authRepository = mock(AuthRepository.class);
		ChapterService chapters = mock(ChapterService.class);
		PasswordService passwords = mock(PasswordService.class);
	...
	@Test
	void updatePasswordVerifiesCurrentPasswordAndStoresNewHash() throws Exception {
		AccountRepository repository = mock(AccountRepository.class);
		AuthRepository authRepository = mock(AuthRepository.class);
		ChapterService chapters = mock(ChapterService.class);
		PasswordService passwords = mock(PasswordService.class);
		expect(authRepository.findByUsername("user")).andReturn(credentials()).times(2);
	...
	@Test
	void affiliationOperationsEnforceRulesAndDelegate() throws Exception {
		AccountRepository repository = mock(AccountRepository.class);
		AuthRepository authRepository = mock(AuthRepository.class);
		ChapterService chapters = mock(ChapterService.class);
		PasswordService passwords = mock(PasswordService.class);
