...
public class AccountRepository {
  ...
  public int createVolunteer(
    ...
    try (CallableStatement stmt =
        conn.prepareCall("call Insert_Volunteer_For_Chapter(?, ?, ?, ?, ?, ?, ?)")) {
  ...
  public List<AccountSummary> getVolunteersForChapters(List<Integer> chapterIds)
      throws SQLException {
    ensureConnected();
    Connection conn = DatabaseConnectionService.getConnection();
    try (PreparedStatement ps =
        conn.prepareStatement("SELECT * FROM Get_Volunteers_For_Chapters(?)")) {
  ...
  public void updateAffiliation(int volunteerId, int chapterId, String roleName)
      throws SQLException {
    ensureConnected();
    Connection conn = DatabaseConnectionService.getConnection();
  ...
  public void updatePassword(int volunteerId, String passwordHash, String passwordSalt)
      throws SQLException {
    ensureConnected();
    Connection conn = DatabaseConnectionService.getConnection();
