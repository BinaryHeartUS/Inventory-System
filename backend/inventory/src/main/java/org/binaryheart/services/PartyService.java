...
public class PartyService {
  ...
  public List<GetPartyResponse> getAllParties(boolean getPerson, boolean getOrg)
      throws SQLException {
    if (getPerson && getOrg) {
      // get all parties
  ...
  public GetPartyResponse getParty(int id)
      throws BadArgumentException, PartyNotFoundException, SQLException {
    if (id <= 0) {
