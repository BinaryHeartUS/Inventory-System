...
public class PartController {
  ...
  @OpenApi(
      ...
      responses = {
        @OpenApiResponse(
            ...
            content = {@OpenApiContent(from = PartResponse[].class)}),
  ...
  @OpenApi(
      ...
      responses = {
        ...
        @OpenApiResponse(status = "404", description = "No part with provided ID found"),
        @OpenApiResponse(status = "500", description = "Database error"),
      })
  ...
  @OpenApi(
      ...
      pathParams = {@OpenApiParam(name = "id", required = true, description = "Part ID to delete")},
      responses = {
        @OpenApiResponse(
            status = "204",
  ...
  public static void deletePart(Context ctx) {
    try {
      List<Integer> userChapterIds = ctx.attribute("chapterIds");
      service.deletePart(
          userChapterIds, Integer.parseInt(ctx.pathParam("id")), ctx.attribute("username"));
      ctx.status(204);
    } catch (SQLException e) {
      ctx.status(500).result("Datbase error: ".concat(e.getMessage()));
  ...
  @OpenApi(
      ...
      pathParams = {@OpenApiParam(name = "id", required = true, description = "Part ID to update")},
      requestBody =
          @OpenApiRequestBody(
              required = true,
              content = {
      ...
      responses = {
        ...
        @OpenApiResponse(status = "401", description = "Part with specified ID does not exist"),
        @OpenApiResponse(status = "500", description = "Database error"),
      })
  ...
  @OpenApi(
      ...
      responses = {
        @OpenApiResponse(
            ...
            description = "Parts fetched successfully",
            content = {@OpenApiContent(from = PartResponse[].class)}),
        @OpenApiResponse(status = "400", description = "Non-positive or non-numeric device ID"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  ...
  @OpenApi(
      ...
      responses = {
        @OpenApiResponse(status = "201", description = "Part added successfully"),
        @OpenApiResponse(
            status = "400",
  ...
  @OpenApi(
      ...
      responses = {
        @OpenApiResponse(
            ...
            content = {@OpenApiContent(from = PartChangelogResponse[].class)}),
        @OpenApiResponse(status = "400", description = "Non-positive or non-numeric ID provided"),
        @OpenApiResponse(status = "404", description = "Part not found"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
