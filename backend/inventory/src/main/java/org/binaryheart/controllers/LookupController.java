...
public class LookupController {
  ...
  public static void registerRoutes() {
    ...
    delete(
        ...
        LookupController::deleteOperatingSystem,
        AppRole.CHAPTER_ADMIN);
  }
  ...
  @OpenApi(
      ...
      responses = {
        @OpenApiResponse(
            ...
            content = {@OpenApiContent(from = LookupResponse.class)}),
  ...
  @OpenApi(
      ...
      requestBody =
          @OpenApiRequestBody(
              required = true,
              content = {@OpenApiContent(from = AddLookupRequest.class)}),
      responses = {
        @OpenApiResponse(status = "201", description = "Added"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  ...
  @OpenApi(
      ...
      pathParams = {@OpenApiParam(name = "name")},
      responses = {
  ...
  public static void deleteManufacturer(Context ctx) {
    ...
    try {
      ...
      else ctx.status(500).result("Database error: " + e.getMessage());
    }
  }
