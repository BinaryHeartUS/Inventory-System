...
public class DeviceController {
  ...
  public static void registerRoutes() {
    path(
        ...
        () -> {
          ...
          get(
              "/chapter-activity",
              DeviceController::getChapterActivityStats,
  ...
  @OpenApi(
      ...
      description =
          "Returns all eight pipeline and device-type counts needed by the dashboard in one call, "
      ...
      queryParams = {
        @OpenApiParam(
            ...
            required = false,
            description =
                "Comma-separated list of chapter IDs to filter by. Defaults to all accessible chapters.")
      },
      responses = {
        @OpenApiResponse(
            status = "200",
            description = "Dashboard counts retrieved successfully",
            content = {@OpenApiContent(from = DashboardCountsResponse.class)}),
        @OpenApiResponse(status = "400", description = "Invalid chapter ID"),
        @OpenApiResponse(status = "403", description = "Access denied for a requested chapter"),
  ...
  @OpenApi(
      ...
      description =
          "Returns the count of devices by type and status, optionally filtered to specific chapters. "
              + "Status values: active (default), not-started, in-progress, ready-to-donate, donated. "
              + "Type values: desktop, laptop, tablet, total.",
      pathParams = {
        @OpenApiParam(name = "type", description = "Device type: desktop, laptop, tablet, or total")
      },
      queryParams = {
        @OpenApiParam(
            name = "status",
            required = false,
            description =
                "Filter by status: active (default), not-started, in-progress, ready-to-donate, donated"),
        @OpenApiParam(
            name = "chapters",
            required = false,
            description =
  ...
  public static void getDeviceCount(Context ctx) {
    ...
    String status =
        ctx.queryParam("status") == null ? "active" : ctx.queryParam("status").toLowerCase();
  ...
  @OpenApi(
      ...
      description =
          "Returns the average number of days between acquisition and donation for donated devices, "
              + "optionally filtered to specific chapters.",
      queryParams = {
        @OpenApiParam(
            name = "chapters",
      ...
      responses = {
        @OpenApiResponse(
            ...
            content = {@OpenApiContent(from = AvgTimeInInventoryResponse.class)}),
        @OpenApiResponse(status = "403", description = "Access denied for a requested chapter"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  ...
  @OpenApi(
      ...
      description =
          "Returns the count of donated devices and the count of all non-scrapped/unknown devices, "
              + "optionally filtered to specific chapters.",
      queryParams = {
        @OpenApiParam(
            name = "chapters",
      ...
      responses = {
        @OpenApiResponse(
            ...
            content = {@OpenApiContent(from = CompletionRateResponse.class)}),
        @OpenApiResponse(status = "403", description = "Access denied for a requested chapter"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  ...
  @OpenApi(
      ...
      description =
          "Returns counts of active chapters, chapters working on devices, and chapters with pickups ready, "
              + "across all chapters visible to the caller.",
      responses = {
        @OpenApiResponse(
            status = "200",
            description = "Chapter activity stats retrieved successfully",
            content = {@OpenApiContent(from = ChapterActivityStatsResponse.class)}),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  ...
  @OpenApi(
      ...
      description =
          "Returns the count of devices received (by acquisition date) per month for the last N months (default 12). "
              + "Optionally filtered to specific chapters.",
      queryParams = {
        @OpenApiParam(
            name = "months",
      ...
      responses = {
        @OpenApiResponse(
            ...
            content = {@OpenApiContent(from = MonthlyCountPoint[].class)}),
        @OpenApiResponse(status = "400", description = "Invalid months value or chapter ID"),
        @OpenApiResponse(status = "403", description = "Access denied for a requested chapter"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  ...
  @OpenApi(
      ...
      description =
          "Returns the count of devices donated per month for the last N months (default 12). "
              + "Optionally filtered to specific chapters.",
      queryParams = {
        @OpenApiParam(
            name = "months",
  ...
  @OpenApi(
      ...
      description =
          "Returns the total value of donated devices per month for the last N months (default 12). "
              + "Optionally filtered to specific chapters.",
      queryParams = {
        @OpenApiParam(
            name = "months",
      ...
      responses = {
        @OpenApiResponse(
            ...
            content = {@OpenApiContent(from = MonthlyValuePoint[].class)}),
        @OpenApiResponse(status = "400", description = "Invalid months value or chapter ID"),
        @OpenApiResponse(status = "403", description = "Access denied for a requested chapter"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  public static void getDonatedDeviceValue(Context ctx) {
    try {
      ...
      List<Integer> userChapterIds = ctx.attribute("chapterIds");
      ctx.status(200)
          .json(service.getDonatedDeviceValue(requestedChapterIds, userChapterIds, months));
    } catch (BadArgumentException e) {
      ctx.status(400).result(e.getMessage());
    } catch (ForbiddenException e) {
      ctx.status(403).result(e.getMessage());
  ...
  @OpenApi(
      ...
      responses = {
        @OpenApiResponse(
            ...
            content = {@OpenApiContent(from = GetDeviceResponse.class)}),
        @OpenApiResponse(status = "400", description = "Non-numeric or non-positive device ID"),
        @OpenApiResponse(status = "404", description = "ID does not match any existing devices"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  public static void getDevice(Context ctx) {
    ...
    try {
      ...
      if (deviceChapterId == null) throw new ForbiddenResponse("Access denied");
  ...
  @OpenApi(
      ...
      responses = {
        @OpenApiResponse(status = "201", description = "Desktop added successfully"),
        @OpenApiResponse(
            status = "400",
            description = "Missing required parameters or invalid field values"),
        @OpenApiResponse(status = "409", description = "Asset ID already exists"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  ...
  @OpenApi(
      ...
      responses = {
        @OpenApiResponse(status = "201", description = "Laptop added successfully"),
        @OpenApiResponse(
            status = "400",
            description = "Missing required parameters or invalid field values"),
        @OpenApiResponse(status = "409", description = "Asset ID already exists"),
  ...
  @OpenApi(
      ...
      responses = {
        @OpenApiResponse(status = "201", description = "Tablet added successfully"),
        @OpenApiResponse(
            status = "400",
            description = "Missing required parameters or invalid field values"),
        @OpenApiResponse(status = "409", description = "Asset ID already exists"),
  ...
  @OpenApi(
      ...
      pathParams = {
        @OpenApiParam(name = "id", description = "The asset ID of the desktop to update"),
      },
      requestBody =
          @OpenApiRequestBody(
              required = true,
      ...
      responses = {
        @OpenApiResponse(status = "201", description = "Desktop updated successfully"),
        @OpenApiResponse(
            status = "400",
            description = "Missing required parameters or invalid field values"),
        @OpenApiResponse(status = "401", description = "Desktop with specified ID does not exist"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  ...
  @OpenApi(
      ...
      pathParams = {
        @OpenApiParam(name = "id", description = "The asset ID of the laptop to update"),
      },
      requestBody =
          @OpenApiRequestBody(
              required = true,
      ...
      responses = {
        @OpenApiResponse(status = "201", description = "Laptop updated successfully"),
        @OpenApiResponse(
            status = "400",
            description = "Missing required parameters or invalid field values"),
        @OpenApiResponse(status = "401", description = "Laptop with specified ID does not exist"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  ...
  @OpenApi(
      ...
      pathParams = {
        @OpenApiParam(name = "id", description = "The asset ID of the tablet to update"),
      },
      requestBody =
          @OpenApiRequestBody(
              required = true,
      ...
      responses = {
        @OpenApiResponse(status = "201", description = "Tablet updated successfully"),
        @OpenApiResponse(
            status = "400",
            description = "Missing required parameters or invalid field values"),
        @OpenApiResponse(status = "401", description = "Tablet with specified ID does not exist"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  ...
  @OpenApi(
      ...
      responses = {
        @OpenApiResponse(
            ...
            content = {@OpenApiContent(from = DeviceChangelogResponse[].class)}),
        @OpenApiResponse(status = "400", description = "Non-positive or non-numeric ID provided"),
