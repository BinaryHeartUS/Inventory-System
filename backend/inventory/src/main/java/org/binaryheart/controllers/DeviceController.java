...
public class DeviceController {
	...
	@OpenApi(
			...
			responses = { @OpenApiResponse(
					...
					content = { @OpenApiContent(
							from = DashboardCountsResponse.class) }),
					@OpenApiResponse(
							status = "400",
	...
	@OpenApi(
			...
			responses = { @OpenApiResponse(
					...
					content = { @OpenApiContent(
							from = AvgTimeInInventoryResponse.class) }),
					@OpenApiResponse(
							status = "403",
							description = "Access denied for a requested chapter"),
					@OpenApiResponse(
	...
	@OpenApi(
			...
			responses = { @OpenApiResponse(
					...
					content = { @OpenApiContent(
							from = CompletionRateResponse.class) }),
					@OpenApiResponse(
							status = "403",
							description = "Access denied for a requested chapter"),
					@OpenApiResponse(
	...
	@OpenApi(
			...
			responses = { @OpenApiResponse(
					...
					content = { @OpenApiContent(
							from = ChapterActivityStatsResponse.class) }),
					@OpenApiResponse(
							status = "500",
							description = "Database error") })
