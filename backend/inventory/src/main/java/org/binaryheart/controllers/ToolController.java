...
public class ToolController {
  ...
  @OpenApi(
      ...
      responses = {
        @OpenApiResponse(
            ...
            content = {@OpenApiContent(from = GetToolResponse[].class)}),
  ...
  @OpenApi(
      ...
      pathParams = {
        @OpenApiParam(name = "id", description = "Tool ID: A unique number assigned to each tool")
      },
      responses = {
        @OpenApiResponse(
            status = "200",
            ...
            content = {@OpenApiContent(from = GetToolResponse.class)}),
        @OpenApiResponse(status = "400", description = "Non-numeric or non-positive tool ID"),
        @OpenApiResponse(status = "404", description = "ID does not match any existing tools"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  ...
  @OpenApi(
      ...
      responses = {
        @OpenApiResponse(status = "201", description = "Tool added successfully"),
        @OpenApiResponse(
            status = "400",
  ...
  @OpenApi(
      ...
      pathParams = {@OpenApiParam(name = "id", required = true, description = "Tool ID to delete")},
      responses = {
        @OpenApiResponse(
            status = "204",
  ...
  @OpenApi(
      ...
      pathParams = {@OpenApiParam(name = "id", description = "The asset ID of the tool to update")},
      requestBody =
          @OpenApiRequestBody(
              required = true,
              content = {
      ...
      responses = {
        @OpenApiResponse(status = "201", description = "Tool updated successfully"),
        @OpenApiResponse(
            status = "400",
            description = "Missing required parameters or invalid field values"),
        @OpenApiResponse(status = "401", description = "Tool with specified ID does not exist"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
  ...
  @OpenApi(
      ...
      responses = {
        @OpenApiResponse(
            ...
            content = {@OpenApiContent(from = ToolChangelogResponse[].class)}),
        @OpenApiResponse(status = "400", description = "Non-positive or non-numeric ID provided"),
        @OpenApiResponse(status = "404", description = "Tool not found"),
        @OpenApiResponse(status = "500", description = "Database error")
      })
